...
<body ng-app='memo'>
    ...
    <div class="dropdown"> 
        <div id="myDropdown" class="dropdown-content">
            ...
            <select class="form-control val-check" type='text' ng-model='respost.id_room'>
            ...
            <input class="form-control val-check-1 col-md-12" type="date" required>
            <label for="#">
                <strong>Time</strong>
            </label><br>
            <input class="form-control val-check-1 col-md-5 left" value="00:00" type="time" required>
            <span class='col-md-2'><strong>To</strong></span>
            <input class="form-control val-check col-md-5 right" value="00:00" type="time" required>
            <label for="#">
